# Cross-sell widget v kategorii — zadání (export 2026-08-25 13:00)
...
5. **Modal „Skvělé ke chlebu":** všechny tři klikací plochy otevírají modal velikosti
   ...
   kategorií (v prototypu prvních 20 z každé), **taby** nad gridem: Vše (výchozí) ·
   Máslo · Pomazánkové máslo · Pomazánky · Šunky · Salámy · Sýry (DS Tabs, varianta
   white; na mobilu horizontálně scrollovatelné). Přepnutí tabu filtruje grid a vrací
   scroll nahoru; při novém otevření modalu je aktivní „Vše".
